...
[T6,Y6]=ode45(@(t,y) traj1(t,y,optx),[t5,t6],Y5(end,:));

eq1=(c2-c1*T5(end))*sin(Y5(end,5))+(c4-c3*T5(end))*cos(Y5(end,5));
 
 
c=[];
ceq=[Y6(end,1)-5;Y6(end,2);Y6(end,3)-5;Y6(end,4);Y6(end,5);Y1(end,6);Y3(end,6);eq1;Y2(end,6)];
